...
<!DOCTYPE html>
 <html style="color: rgb(235, 252, 9);font-weight: bolder ;">
    <p style="font-size: 130%;margin-left: 560px;font-family: sans-serif;color: aquamarine;text-shadow: 20px;">
         SLOT TIMETABLE - MONISH KUMAR N(212224100037)</p>
    <center>
...
```
# OUTPUT
![Screenshot 2025-04-24 211039](https://github.com/user-attachments/assets/c1b6cf6f-98ff-4ce2-bb05-194ff6856663)
